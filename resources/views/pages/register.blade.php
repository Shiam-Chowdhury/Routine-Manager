  ...
  <div class="container"> 
    <div class="row">
        <!--<div class="col-md-6">-->
            ...
            <div class="form-group">
                <label for="username"><span class="req">* </span> University Name:  <small>This will be your university name</small> </label> 
                    <input class="form-control" type="text" name="university" id = "univ" onkeyup = "Validate(this)" required />  
                        <div id="errLast"></div>
            </div>
